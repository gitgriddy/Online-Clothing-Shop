...
public class Hoodie extends allClothes implements Serializable, Comparable<allClothes>{
	...
	public Hoodie(String size, String style, double price) {
		super(style, price);
		this.style = style;
		this.size = size;
		this.price = price;
	...
	public boolean equals(Object o) {
		...
		return Double.compare(price, hoodie.price) == 0 && Objects.equals(size, hoodie.size) && Objects.equals(style, hoodie.style);
	}
	...
	public int compareTo(Hoodie other) {
